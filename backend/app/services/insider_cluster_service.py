...
class InsiderClusterService:
    ...
    async def get_cluster_detail(cluster_id: str, confidence_stats: Optional[dict] = None) -> Optional[dict]:
        ...
        return {
            ...
            # research_notes is composed by the event_detail route, not here —
            # this service must not reach into ResearchNoteService's own Neo4j
            # client, which callers patching THIS module's client cannot see.
        }
