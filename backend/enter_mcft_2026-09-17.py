"""One-off portfolio entry: MCFT, 2026-09-17, per the locked paper-portfolio spec.

MCFT signalled 2026-09-16 (day-0 $19.15) and was KEPT on per-arrival review:
the CEO and a director bought four days after the FY26 release that published
explicit transition-period guidance, on a debt-free balance sheet in a levered
sector. See the ResearchNote of 2026-09-17.
...
NOTE: MCFT is one of TWO entries on 2026-09-17 (the other is the sibling script),
...
Resumable: counts today's already-filled MCFT buys on start and skips that many.

Run detached inside the backend container:
    docker exec -d lookinsight-backend python enter_mcft_2026-09-17.py --commit
Log: /app/backend/enter_mcft_2026-09-17.log (inside container)
...
SIGNAL_ID = "CLUSTER-0001638290-2026-09-16"
SIGNAL_DATE = "2026-09-16"
DAY0_PRICE = 19.15
EXIT_DATE = "2026-12-15"  # day-90; resolves forward at exit time if non-trading

LOG_PATH = Path(__file__).parent / "enter_mcft_2026-09-17.log"
